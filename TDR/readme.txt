...
Martínez, estudiants de segon de Batxillerat tecnològic, per a un Treball de Recerca de criptografia.
...
Instruccions:
- Botó d'encriptament: Introdutr al primer quadre de text la frase i en el segon la clau. Després prémer el botó.
...
- Botó d'enviament: Seguir instruccions del primer botó, però s'ha de prémer el botó d'encriptar i enviar. En la següent
		    pantalla, introduïr una adreça de correu vàlida per a l'enviament* i una altra a la que enviar el 
		    missatge.
